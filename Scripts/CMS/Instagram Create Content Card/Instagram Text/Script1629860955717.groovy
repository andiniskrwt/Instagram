...
WebUI.setText(findTestObject('CMS/Content Card/Card Type/Text/inputText'), 'This text created by Katalon Automation')

WebUI.click(findTestObject('CMS/Content Card/Create Card/malayTab'))

WebUI.setText(findTestObject('CMS/Content Card/Card Type/Text/inputTextMalay'), 'Teks ini dibuat oleh Katalon Automation')

WebUI.click(findTestObject('CMS/Content Card/Create Card/btnSave'))

WebUI.waitForPageLoad(0)

WebUI.takeScreenshot('Screenshot\\IGTextResult.png')
