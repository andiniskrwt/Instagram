...
WebUI.setText(findTestObject('CMS/Content Card/Card Type/Customer attribute/input Attribute'), 'Customer Language')
...
WebUI.setText(findTestObject('CMS/Content Card/Card Type/Customer attribute/input attribute value'), 'english')
...
WebUI.takeFullPageScreenshot('Screenshot\\IGCustAttribute.png')
