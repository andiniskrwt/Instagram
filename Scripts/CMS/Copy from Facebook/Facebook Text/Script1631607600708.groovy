...
WebUI.setText(findTestObject('CMS/Content Card/Card Type/Text/inputText'), 'This text created by Katalon Automation [ Copy from Facebook ]')

WebUI.click(findTestObject('CMS/Content Card/Facebook Card Type/Text/inputText'))

WebUI.click(findTestObject('CMS/Content Card/Create Card/malayTab'))

WebUI.setText(findTestObject('CMS/Content Card/Facebook Card Type/Text/textInMalay'), 'Teks ini dibuat oleh Katalon Automation')

WebUI.click(findTestObject('CMS/Content Card/Create Card/btnSaveCard'))

WebUI.delay(1)

WebUI.takeFullPageScreenshot('Screenshot\\FB direct TextResult.png')
...
WebUI.takeFullPageScreenshot('Screenshot\\Copy From FB Text.png')
