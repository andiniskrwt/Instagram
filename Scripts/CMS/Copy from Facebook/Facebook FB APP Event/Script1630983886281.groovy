...
WebUI.selectOptionByLabel(findTestObject('CMS/Content Card/Create Card/cardDropdown'), 'FB App Event', false)

WebUI.selectOptionByValue(findTestObject('CMS/Content Card/Facebook Card Type/FB APP event/eventType'), 'standard', false)

WebUI.selectOptionByValue(findTestObject('CMS/Content Card/Facebook Card Type/FB APP event/eventName'), 'fb_mobile_level_achieved', 
    false)

WebUI.setText(findTestObject('CMS/Content Card/Facebook Card Type/FB APP event/parameterValue'), 'fbtest')

WebUI.click(findTestObject('CMS/Content Card/Create Card/btnSaveCard'))

WebUI.takeScreenshot('Screenshot\\FBAppEvent.png')
...
WebUI.takeFullPageScreenshot('Screenshot\\FB app event Copy from FB.png')
...
WebUI.takeFullPageScreenshot('Screenshot\\FB app event Copy from FB 2.png')
