...
WebUI.selectOptionByLabel(findTestObject('CMS/Content Card/Create Card/cardDropdown'), 'Product', false)

WebUI.click(findTestObject('CMS/Content Card/Create Card/btnSaveCard'))

WebUI.takeScreenshot('Screenshot\\FBProduct.png')
...
WebUI.takeFullPageScreenshot('Screenshot\\Product Copy from FB.png')
...
WebUI.takeFullPageScreenshot('Screenshot\\Product Copy from FB 2.png')
