...
WebUI.selectOptionByLabel(findTestObject('CMS/Content Card/Create Card/cardDropdown'), 'Store Locator', false)

WebUI.click(findTestObject('CMS/Content Card/Facebook Card Type/Store Locator/beforeResultMessage'))

WebUI.setText(findTestObject('CMS/Content Card/Facebook Card Type/Store Locator/beforeResultMessage'), 'Here are the result')
...
WebUI.sendKeys(findTestObject('CMS/Content Card/Facebook Card Type/Promotion Listing/SelectAction_search'), Keys.chord(Keys.ENTER))
...
WebUI.setText(findTestObject('CMS/Content Card/Facebook Card Type/Store Locator/beforeResultMessage'), 'ini adalah hasil')

WebUI.click(findTestObject('CMS/Content Card/Create Card/btnSaveCard'))

WebUI.takeScreenshot('Screenshot\\Store Locator.png')
...
WebUI.takeFullPageScreenshot('Screenshot\\Store Locator Warning message.png')
...
WebUI.takeFullPageScreenshot('Screenshot\\Store Locator Warning message 2.png')
