...
WebUI.takeFullPageScreenshot('Screenshot\\FB Text before QR.png')
...
WebUI.uploadFile(findTestObject('CMS/Content Card/Card Type/image/uploadImage'), 'D:\\AiChat\\Instagram\\Data Files\\6.png')
...
WebUI.takeFullPageScreenshot('Screenshot\\FBQuickReplyResult.png')
...
WebUI.verifyTextPresent('Quick Reply Image attachment not supported by IG.', false)

WebUI.takeFullPageScreenshot('Screenshot\\Copy From FB Quick Reply.png')
